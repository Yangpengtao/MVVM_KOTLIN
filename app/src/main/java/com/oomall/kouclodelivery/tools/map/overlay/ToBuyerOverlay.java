 ...
 * 从商家到买家的距离的骑行路线图层类。
 */
public class ToBuyerOverlay extends RouteOverlay {
     ...
     * @since V3.5.0
     */
    public ToBuyerOverlay(Context context, AMap amap, RidePath path,
    ...
    private void initPolylineOptions() {
        ...
        mPolylineOptions.color(getToBuyerColor()).width(getRouteWidth());
    }
